...
import { CompleteProgression, getProgressionFromUser } from "../../../services/progression.service";
import { useConntedUser } from "../../../utils/ConnectedUserContext";
import { ProgressBar, Text, useTheme, FAB, Chip, PaperProvider } from "react-native-paper";
import { SignInButton } from "../../../components/SignInButton";
import { FlatList, StyleSheet, View } from "react-native";
import { getRessource } from "../../../services/articles.service";
          ...
          <View style={styles.container}>
            ...
            {userRessourceStep && (
              <View style={styles.progressionContainer}>
                ...
                <ProgressBar progress={getProgress(completedStep(userRessourceStep), userRessourceStep.length)} style={styles.progressBar} />
                <FlatList
                  data={userRessourceStep}
                  keyExtractor={(item) => `${item.id}_card`}
                  renderItem={({ item }) => <StepCheckerList step={item} onCheckStepChange={handleCheckStepChange} />}
            ...
            <FAB style={styles.fab} icon="message" customSize={70} onPress={() => router.push(`/chatScreen?ressourceId=${userRessource.id}`)} />
          </View>
        ) : (
